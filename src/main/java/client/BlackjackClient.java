...
public class BlackjackClient {
    ...
    private static final String USERNAME = "tle"; // replace with your username
    private static final String PASSWORD = "24b3790"; // replace with your from the file posted to Classroom
